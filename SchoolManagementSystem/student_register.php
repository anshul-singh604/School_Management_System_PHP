...
<?php
  ...
  if(isset($_POST['register'])){
	...
	$query = "insert into students values ('$_POST[fname]',lname='$_POST[lname]',mother_name='$_POST[mother_name]',father_name='$_POST[father_name]',dob='$_POST[dob]',gender='$_POST[gender]',category='$_POST[category]',mobile=$_POST[mobile],class=$_POST[class],status='$_POST[status]',address='$_POST[address]','$_POST[roll_no]','$_POST[fee_status]')";
  ...
  <head>
    ...
    <script type="text/javascript">
      function resetData(){
		...
		document.getElementById('fee_status').value = "";
      }
    </script>
  </head>
    ...
    <div class="container">
    	...
    	<form action="" method="POST">
          ...
          <tr>
			...
			<div class="form-group">
    					    <label>Fee Status:-(<span style="color:red;">*</span>)</label>
                  <select class="form-control" name="fee_status" id="fee_status" required="">
      	  						<option>-Select-</option>
      	  						<option>0</option>
      	  						<option>1</option>
      						</select>
